            ...
            <div class="ms-footer-wrap">
                <div class="ms-footer-grid">
                    ...
                    <div class="ms-footer-col ms-footer-col-news">
                        ...
                        <?php
                        $footerFb = trim((string)($brand['footer_facebook_url'] ?? ''));
                        if ($footerFb === '') $footerFb = 'https://facebook.com';
                        $footerInsta = trim((string)($brand['footer_instagram_url'] ?? ''));
                        if ($footerInsta === '') $footerInsta = 'https://instagram.com';
                        $footerWa = trim((string)($brand['footer_whatsapp_url'] ?? ''));
                        if ($footerWa === '' && $careWhatsapp) {
                            $cleanWa = preg_replace('/[^0-9]/', '', $careWhatsapp);
                            if ($cleanWa !== '') $footerWa = 'https://wa.me/' . $cleanWa;
                        }
                        ?>
                        <div class="ms-footer-socials">
                            <a href="<?= e($footerFb) ?>" target="_blank" rel="noopener noreferrer" class="ms-footer-social-icon" aria-label="Facebook" title="Facebook">
                                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M22.675 0h-21.35C.597 0 0 .597 0 1.325v21.351C0 23.403.597 24 1.325 24H12.82v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116c.73 0 1.323-.597 1.323-1.325V1.325C24 .597 23.403 0 22.675 0z"/></svg>
                            </a>
                            <a href="<?= e($footerInsta) ?>" target="_blank" rel="noopener noreferrer" class="ms-footer-social-icon" aria-label="Instagram" title="Instagram">
                            ...
                            <?php if ($footerWa !== ''): ?>
                                <a href="<?= e($footerWa) ?>" target="_blank" rel="noopener noreferrer" class="ms-footer-social-icon" aria-label="WhatsApp" title="WhatsApp">
