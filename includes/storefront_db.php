...
function ensure_online_store_schema(): void {
    ...
    // Home Hero Banner Slider Schema
    add_schema_column_if_missing($db, 'mobile_store_settings', 'show_home_hero_banner', "TINYINT(1) NOT NULL DEFAULT 1");
    add_schema_column_if_missing($db, 'mobile_store_settings', 'home_hero_banner', "VARCHAR(255) NULL DEFAULT NULL");
    add_schema_column_if_missing($db, 'mobile_store_settings', 'home_hero_banner_link', "VARCHAR(255) NULL");
    add_schema_column_if_missing($db, 'mobile_store_settings', 'home_hero_banner_2', "VARCHAR(255) NULL");
    add_schema_column_if_missing($db, 'mobile_store_settings', 'home_hero_banner_link_2', "VARCHAR(255) NULL");
    add_schema_column_if_missing($db, 'mobile_store_settings', 'home_hero_banner_3', "VARCHAR(255) NULL");
    add_schema_column_if_missing($db, 'mobile_store_settings', 'home_hero_banner_link_3', "VARCHAR(255) NULL");
    add_schema_column_if_missing($db, 'mobile_store_settings', 'home_hero_banner_4', "VARCHAR(255) NULL");
    add_schema_column_if_missing($db, 'mobile_store_settings', 'home_hero_banner_link_4', "VARCHAR(255) NULL");
    add_schema_column_if_missing($db, 'mobile_store_settings', 'home_hero_banner_5', "VARCHAR(255) NULL");
    add_schema_column_if_missing($db, 'mobile_store_settings', 'home_hero_banner_link_5', "VARCHAR(255) NULL");
    add_schema_column_if_missing($db, 'mobile_store_settings', 'home_hero_autoplay', "TINYINT(1) NOT NULL DEFAULT 1");
    add_schema_column_if_missing($db, 'mobile_store_settings', 'home_hero_autoplay_speed', "INT NOT NULL DEFAULT 4000");
...
function save_mobile_store_settings(int $businessId, array $data, array $files = []): array {
    ...
    $heroBannerPath = $dbRow['home_hero_banner'] ?? null;
...
function send_storefront_otp_whatsapp(string $phone, string $otp, string $storeName, int $businessId = 0): array {
    ...
    $error = null;
    if (!$apiSuccess) {
        $error = 'Could not send OTP from this store\'s WhatsApp API.';
        if ($curlError !== '') {
            $error .= ' ' . $curlError;
