...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'save_preferences' || $action === 'save_customize' || $action === 'publish_layout') {
        ...
        if ($action === 'save_customize' || $action === 'publish_layout') {
            ...
            if (isset($_POST['banner_bg_color'])) $saveData['banner_bg_color'] = $_POST['banner_bg_color'];
            if (isset($_POST['banner_text_color'])) $saveData['banner_text_color'] = $_POST['banner_text_color'];
            ...
            if (isset($_POST['banner_2_bg_color'])) $saveData['banner_2_bg_color'] = $_POST['banner_2_bg_color'];
            if (isset($_POST['banner_2_text_color'])) $saveData['banner_2_text_color'] = $_POST['banner_2_text_color'];
            ...
            if (isset($_POST['banner_4_tag'])) $saveData['banner_4_tag'] = $_POST['banner_4_tag'];
            if (isset($_POST['banner_4_title'])) $saveData['banner_4_title'] = $_POST['banner_4_title'];
            if (isset($_POST['banner_4_subtitle'])) $saveData['banner_4_subtitle'] = $_POST['banner_4_subtitle'];
            if (isset($_POST['banner_4_bg_color'])) $saveData['banner_4_bg_color'] = $_POST['banner_4_bg_color'];
            if (isset($_POST['banner_4_text_color'])) $saveData['banner_4_text_color'] = $_POST['banner_4_text_color'];
            if (isset($_POST['banner_5_tag'])) $saveData['banner_5_tag'] = $_POST['banner_5_tag'];
            if (isset($_POST['banner_5_title'])) $saveData['banner_5_title'] = $_POST['banner_5_title'];
            if (isset($_POST['banner_5_subtitle'])) $saveData['banner_5_subtitle'] = $_POST['banner_5_subtitle'];
            if (isset($_POST['banner_5_bg_color'])) $saveData['banner_5_bg_color'] = $_POST['banner_5_bg_color'];
            if (isset($_POST['banner_5_text_color'])) $saveData['banner_5_text_color'] = $_POST['banner_5_text_color'];
            if (isset($_POST['banner_6_tag'])) $saveData['banner_6_tag'] = $_POST['banner_6_tag'];
            if (isset($_POST['banner_6_title'])) $saveData['banner_6_title'] = $_POST['banner_6_title'];
            if (isset($_POST['banner_6_subtitle'])) $saveData['banner_6_subtitle'] = $_POST['banner_6_subtitle'];
            if (isset($_POST['banner_6_bg_color'])) $saveData['banner_6_bg_color'] = $_POST['banner_6_bg_color'];
            if (isset($_POST['banner_6_text_color'])) $saveData['banner_6_text_color'] = $_POST['banner_6_text_color'];
